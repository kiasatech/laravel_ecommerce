...
@section('title', 'صفحه ورود به حساب کاربری')
    ...
    <script>
        ...
        $('#resendOTPButton').click(function (event){
            ...
            $.post("{{ url('/resend-otp') }}", {
                ...
                Swal.fire({
                    icon: 'success',
                    text: '...رمز یکبار مصرف مجددا ارسال شد',
                    confirmButtonText : '!حله',
                    timer : 3000
                });
                            ...
                            <div id="lg1" class="tab-pane active">
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <form id="loginForm">
                                            <input id="cellphoneInput" class="mb-1" type="text" placeholder="شماره تلفن همراه">
                                            <div id="cellphoneInputError" class="input-error-validation">
                                                <strong id="cellphoneInputErrorText"></strong>
                                            </div>

                                            <div class="button-box d-flex justify-content-between mt-3">
                                                <button type="submit" class="btn-block">ورود</button>
                                            </div>
                                        </form>

                                        <form id="checkOTPForm">
                                            <input id="checkOTPInput" class="mb-1 text-center" type="text" placeholder="کد تایید را وارد کنید">
                                            <div id="checkOTPInputError" class="input-error-validation">
                                                <strong id="checkOTPInputErrorText"></strong>
                                            </div>

                                            <div class="button-box justify-content-between mt-3">
                                                <div class="row justify-content-center">
                                                    <button style="width: 94%!important;" type="submit">تایید</button>
                                                </div>
                                                <div class="row my-3 ml-1 float-left">
                                                    <button id="resendOTPButton" class="px-3 py-2" type="submit">ارسال مجدد</button>
