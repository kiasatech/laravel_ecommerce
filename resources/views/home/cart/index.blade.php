...
@section('content')
    ...
    <div class="cart-main-area pt-95 pb-100 text-right" style="direction: rtl;">
        @if(\Cart::isEmpty())
            <div class="container cart-empty-content" style="display: block;">
                                        ...
                                        <tr>
                                            <td class="product-thumbnail">
                                                <a href="{{ route('home.products.show', $item->associatedModel->slug) }}">
                                                    <img src="{{ asset(env('PRODUCT_IMAGES_UPLOAD_PATH') . $item->associatedModel->primary_image) }}" width="100" alt="">
                                                </a>
                                            </td>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="discount-code-wrapper">
                                    ...
                                    <div class="discount-code">
                                        <p> لطفا کد تخفیف خودتون رو وارد کنید </p>
