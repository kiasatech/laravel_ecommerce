...
@section('title', 'صفحه نهایی سازی سفارش')
        ...
        <div class="container">
            <div class="breadcrumb-content text-center">
                <ul>
                    ...
                    <li class="active"> نهایی سازی سفارش </li>
                </ul>
            </div>
        </div>
    </div>
                                ...
                                <div class="your-order-wrap gray-bg-4">
                                    <div class="your-order-info-wrap">
                                                ...
                                                @foreach(\Cart::getContent() as $item)
                                                    ...
                                                    @if($item->attributes->is_sale)
                                                            ...
                                                            <span style="font-size: 12px">
                                                                <del>{{ number_format($item->associatedModel->price_check->price) }} تومان</del>
                                                            {{ $item->attributes->percent_sale }}% تخفیف
                                                            </span>
                                                        </p>
                                                            @else
                                                                <span>{{ number_format($item->price) }} تومان</span>
                                        ...
                                        <div class="your-order-info order-subtotal">
                                            <ul>
                                                <li>مبلغ کل بدون تخفیف :
                                                    <span>
                                                        {{ number_format(\Cart::getTotal() + cartTotalSaleAmount()) }} تومان
                                                </span>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="your-order-info order-total">
                                            <ul>
                                                <li>جمع کل
                                                    <span>
                                                        {{ number_format(cartTotalAmount()) }} تومان
                                                </span>
                                                </li>
                                            </ul>
                                        </div>
