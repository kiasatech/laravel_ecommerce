...
@section('style')
    ...
    <style> .leaflet-popup-content-wrapper{ text-align: right !important; } </style>
@endsection
...
@section('script')
    ...
    <script>
        ...
        marker.bindPopup("<b style='text-align: right'>!سلام دنیا</b><br>.من پاپ آپ هستم").openPopup();
    </script>
@endsection
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="contact-from contact-shadow">
                        <form id="contact-form" action="{{ route('home.contact-us.form') }}" method="POST">
                            ...
                            @error('name')
                                <p class="input-error-validation" style="margin: -10px 4px 8px 0;">
