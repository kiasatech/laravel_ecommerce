            ...
            <div class="row">
                <div class="col-xl-2 col-lg-2">
                    <div class="logo pt-40">
                        <a href="/">
                            <h3 class="font-weight-bold">KiasaTech.com</h3>
                        </a>
                    </div>
                </div>
                    ...
                    @endif
                                        ...
                                        @foreach(\Cart::getContent() as $item)
                                            <li class="single-shopping-cart">
                                                ...
                                                <div class="shopping-cart-img">
                                                    <a href="{{ route('home.products.show', $item->associatedModel->slug) }}"><img alt="" src="{{ asset(env('PRODUCT_IMAGES_UPLOAD_PATH') . $item->associatedModel->primary_image) }}" /></a>
                        ...
                        <div class="setting-wrap">
                            ...
                            <div class="setting-content">
                                <ul class="text-right">
                                    @auth()
                                        <li><a href="{{ route('home.users_profile.index') }}">پروفایل کاربر</a></li>
                                        <li><a href="{{ route('home.compare.index') }}">لیست مقایسه</a></li>
                                    @else
            ...
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="mobile-logo">
                        <a href="/">
                            <h4 class="font-weight-bold">KiasaTech.com</h4>
                        </a>
                    </div>
                </div>
                <div class="col-6">
